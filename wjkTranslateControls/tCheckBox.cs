...
namespace wjkTranslateControls
{
    ...
    public class tCheckBox : System.Web.UI.WebControls.CheckBox
    {
        ...
        public override string Text
        {
            get
            {
                ...
                return ((s == null) ? String.Empty : trans.translate(temp, strID, "checkBoxText", strLanguage, s));
            }
